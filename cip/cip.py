...
class Sod(object):
  ...
  def __init__(self, npoints = 200, xmin = 0, xmax = 2, dt = 0.001,
               gamma = 1.4, a = 0.65, CSL2 = True, gridpower = 1):
    '''
  ...
  def InitPlot(self):
    ...
    # Analytic solution
    self.xa, self.rhoa, self.pa, self.ua, self.ea = sod_analytic.Sod(self.time)
...
class Escape(object):
  ...
  def __init__(self, npoints = 200, rmin = REARTH, xmax = 20 * REARTH, dt = 0.001,
               gamma = 1.4, a = 0.65, CSL2 = True, gridpower = 1):
    '''
